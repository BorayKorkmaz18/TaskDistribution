...
{
    public class EfTaskProcessingDal : GenericRepositories<TaskProcessing>, ITaskProcessingDal
    {


        public EfTaskProcessingDal(TaskDistributionContext context) : base(context)
        {
        }
